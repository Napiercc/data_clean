...
```bash
cd /path/to/data_clean/pipelines/facebook_comments
```
...
The default model location is `../../../models/Qwen3-32B` from this package, which resolves to the same `benchmark/models/Qwen3-32B` directory used by the post-cleaning scripts:
